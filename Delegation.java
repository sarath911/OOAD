...
class B2 implements IB {
	...
	public int q(int m) {return m + super2.a2+b2;}
 ...
 class C2 implements IC {
	...
	public int q(int m) {return m + super2.super2.a2 + super2.b2 + c2;}
...
class E2 implements IE {
	...
	public int q(int m) {return p(m) + super2.c2;}
	
	public int h() {return a1 + b1 + e1;}
...
class F2 implements IF{
	...
	public int h() {return super2.super2.c2 + f2;}
